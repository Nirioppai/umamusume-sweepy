...
Use template from `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/templates/UI-SPEC.md`
