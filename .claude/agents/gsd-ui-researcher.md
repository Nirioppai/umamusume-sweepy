...
Use template from `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/UI-SPEC.md`
