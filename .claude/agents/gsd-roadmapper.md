...
Reference full template: `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/state.md`.
