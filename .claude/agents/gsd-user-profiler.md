...
<reference>
@C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/user-profiling.md` to load:
