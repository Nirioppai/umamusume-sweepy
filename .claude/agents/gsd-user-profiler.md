...
<reference>
@C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/user-profiling.md` to load:
