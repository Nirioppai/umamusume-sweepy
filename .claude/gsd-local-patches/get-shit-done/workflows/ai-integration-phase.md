...
<required_reading>
@C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/ai-frameworks.md
@C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
