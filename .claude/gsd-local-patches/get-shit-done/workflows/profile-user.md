...
Key references:
- @C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md" "C:/Active Codebase/umamusume-sweepy/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Your profile:    C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/USER-PROFILE.md
```
