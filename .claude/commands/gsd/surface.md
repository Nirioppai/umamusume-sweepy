...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Active Codebase/umamusume-sweepy/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/Active Codebase/umamusume-sweepy/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/Active Codebase/umamusume-sweepy/.claude/commands/gsd
AGENTS_DIR=C:/Active Codebase/umamusume-sweepy/.claude/agents
```
...
<execution_context>
Surface state file: `C:/Active Codebase/umamusume-sweepy/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/Active Codebase/umamusume-sweepy/.claude/skills/.gsd-profile`
Engine module: `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Active Codebase/umamusume-sweepy/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
