...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Active Codebase/umamusume-sweepy/.claude/.gsd-surface.json`
(sibling to `C:/Active Codebase/umamusume-sweepy/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Active Codebase/umamusume-sweepy/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Active Codebase/umamusume-sweepy/.claude/skills`).
...
`C:/Active Codebase/umamusume-sweepy/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Active Codebase/umamusume-sweepy/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Active Codebase/umamusume-sweepy/.claude/.gsd-surface.json`
Install profile marker: `C:/Active Codebase/umamusume-sweepy/.claude/.gsd-profile`
Skill dirs: `C:/Active Codebase/umamusume-sweepy/.claude/skills/gsd-*/`
Engine module: `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
