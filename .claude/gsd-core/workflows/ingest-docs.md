...
```bash
INIT=$(node "C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/bin/gsd-tools.cjs" commit \
