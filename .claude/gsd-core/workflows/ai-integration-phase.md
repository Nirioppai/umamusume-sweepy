...
<required_reading>
@C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/ai-frameworks.md
@C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-eval-planner.md for instructions.
