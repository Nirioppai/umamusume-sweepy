...
<template>
@C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/workflows/transition.md`.
...
- Follow @C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/workflows/diagnose-issues.md
