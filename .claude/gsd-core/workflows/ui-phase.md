...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-ui-checker.md for instructions.
