...
```
Agent(
  prompt="Read C:/Active Codebase/umamusume-sweepy/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/VALIDATION.md`
