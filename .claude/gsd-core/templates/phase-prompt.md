...
<!-- For checkpoint task examples and patterns, see @C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Active Codebase/umamusume-sweepy/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
